...
from scaler.docker.labels import LABEL_INDEX, LABEL_MANAGED, LABEL_SERVICE, MANAGED_VALUE
from scaler.docker.templates import nano_cpus, render_labels, replica_name
