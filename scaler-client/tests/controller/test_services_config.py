...
from scaler.config import ROOT, ServicePolicy, load_services_file
from scaler.controller.policies import build_policy, load_live_policies
from scaler.store.redis_store import RedisStore


def test_services_yml_includes_demo_alpha_beta():
    path = ROOT / "config" / "services.yml"
